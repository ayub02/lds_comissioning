...
def update_listbox():
    ...
    new_update_listbox(lbx4, log4, 'BV63.NPW.ByteArray')
    new_update_listbox(lbx5, log5, 'BV64.NPW.ByteArray')
    new_update_listbox(lbx6, log6, 'BV65.NPW.ByteArray')
    new_update_listbox(lbx7, log7, 'BV66.NPW.ByteArray')
    new_update_listbox(lbx8, log8, 'BV66A.NPW.ByteArray')
