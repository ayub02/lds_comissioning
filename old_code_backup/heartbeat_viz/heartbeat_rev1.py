...
label_EDGE_GPS_SYNC_STATUS = Label(_frame, text='EDGE_GPS_SYNC_STATUS', anchor='e').grid(row=35, column=0, stick=W)
label_EDGE_GPS_SYNC_VAL = Label(_frame, text='EDGE_GPS_SYNC_VAL', anchor='e').grid(row=36, column=0, stick=W)
label_EDGE_MW_COMM_STATUS = Label(_frame, text='EDGE_MW_COMM_STATUS', anchor='e').grid(row=37, column=0, stick=W)
...
label_COMM_FAILURE_COUNT = Label(_frame, text='COMM_FAILURE_COUNT', anchor='e').grid(row=41, column=0, stick=W)
label_COMM_SUCCESS_COUNT = Label(_frame, text='COMM_SUCCESS_COUNT', anchor='e').grid(row=42, column=0, stick=W)
label_AVERAGE_TRANS_TIME = Label(_frame, text='AVERAGE_TRANS_TIME', anchor='e').grid(row=43, column=0, stick=W)
label_QUEUED_NPW_BUFFERS = Label(_frame, text='QUEUED_NPW_BUFFERS', anchor='e').grid(row=44, column=0, stick=W)
label_AVG_RESPONSE_TIME = Label(_frame, text='AVG_RESPONSE_TIME', anchor='e').grid(row=45, column=0, stick=W)
label_PACKET_DROP_COUNT = Label(_frame, text='PACKET_DROP_COUNT', anchor='e').grid(row=46, column=0, stick=W)
...
label_KBS = Label(_frame, text='KBS', width=_width).grid(row=0, column=8, stick=W)
label_MW17 = Label(_frame, text='MW17', width=_width).grid(row=0, column=9, stick=W)
label_MW18 = Label(_frame, text='MW18', width=_width).grid(row=0, column=10, stick=W)
label_MW19 = Label(_frame, text='MW19', width=_width).grid(row=0, column=11, stick=W)
