...
def on_message(_client, _userdata, _message):
    ...
    if 't_hb_MW17' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw17.update_prop(msg['t_hb_MW17'], msg['registerMap_MW17'])
        hb_mw17.create_labels(10)
    if 't_hb_MW18' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw18.update_prop(msg['t_hb_MW18'], msg['registerMap_MW18'])
        hb_mw18.create_labels(11)
    if 't_hb_MW19' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw19.update_prop(msg['t_hb_MW19'], msg['registerMap_MW19'])
        hb_mw19.create_labels(12)
...
class HeartBeat:
    ...
    def create_labels(self, _column):
        ...
        var_NUM_SAMPLES_PT_PERIODIC = Label(_frame, text=str(self.NUM_SAMPLES_PT_PERIODIC.get())).grid(row=27,
                                                                                                       column=_column)
        var_EDGE_START_TIME = Label(_frame, text=str(self.EDGE_START_TIME.get())).grid(row=28, column=_column)
        var_EDGE_RAM = Label(_frame, text=str(self.EDGE_RAM.get())).grid(row=29, column=_column)
        var_EDGE_STORAGE = Label(_frame, text=str(self.EDGE_STORAGE.get())).grid(row=30, column=_column)
        var_EDGE_CPU = Label(_frame, text=str(self.EDGE_CPU.get())).grid(row=31, column=_column)
        var_EDGE_CPU_TEMP = Label(_frame, text=str(self.EDGE_CPU_TEMP.get())).grid(row=32, column=_column)
        var_EDGE_GPS_SYNC_STATUS = Label(_frame, text=str(self.EDGE_GPS_SYNC_STATUS.get())).grid(row=33, column=_column)
        var_EDGE_GPS_SYNC_VAL = Label(_frame, text=str(self.EDGE_GPS_SYNC_VAL.get())).grid(row=34, column=_column)
        var_EDGE_MW_COMM_STATUS = Label(_frame, text=str(self.EDGE_MW_COMM_STATUS.get())).grid(row=35, column=_column)
        var_BAD_VAL_COUNT = Label(_frame, text=str(self.BAD_VAL_COUNT.get())).grid(row=36, column=_column)
        var_BAD_CRC_COUNT = Label(_frame, text=str(self.BAD_CRC_COUNT.get())).grid(row=37, column=_column)
        var_NO_RSPNS_COUNT = Label(_frame, text=str(self.NO_RSPNS_COUNT.get())).grid(row=38, column=_column)
        var_COMM_FAILURE_COUNT = Label(_frame, text=str(self.COMM_FAILURE_COUNT.get())).grid(row=39, column=_column)
        var_COMM_SUCCESS_COUNT = Label(_frame, text=str(self.COMM_SUCCESS_COUNT.get())).grid(row=40, column=_column)
        var_AVERAGE_TRANS_TIME = Label(_frame, text=str(self.AVERAGE_TRANS_TIME.get())).grid(row=41, column=_column)
        var_QUEUED_NPW_BUFFERS = Label(_frame, text=str(self.QUEUED_NPW_BUFFERS.get())).grid(row=42, column=_column)
        var_AVG_RESPONSE_TIME = Label(_frame, text=str(self.AVG_RESPONSE_TIME.get())).grid(row=43, column=_column)
        var_PACKET_DROP_COUNT = Label(_frame, text=str(self.PACKET_DROP_COUNT.get())).grid(row=44, column=_column)
...
label_SAMPLE_INTERVAL_NPW = Label(_frame, text='SAMPLE_INTERVAL_NPW', anchor='e').grid(row=10, column=0, stick=W)
...
label_NUM_SAMPLES_PT_PERIODIC = Label(_frame, text='NUM_SAMPLES_PT_PERIODIC', anchor='e').grid(row=27, column=0, stick=W)
label_EDGE_START_TIME = Label(_frame, text='EDGE_START_TIME', anchor='e').grid(row=28, column=0, stick=W)
label_EDGE_RAM = Label(_frame, text='EDGE_RAM', anchor='e').grid(row=29, column=0, stick=W)
label_EDGE_STORAGE = Label(_frame, text='EDGE_STORAGE', anchor='e').grid(row=30, column=0, stick=W)
label_EDGE_CPU = Label(_frame, text='EDGE_CPU', anchor='e').grid(row=31, column=0, stick=W)
label_EDGE_CPU_TEMP = Label(_frame, text='EDGE_CPU_TEMP', anchor='e').grid(row=32, column=0, stick=W)
label_EDGE_GPS_SYNC_STATUS = Label(_frame, text='EDGE_GPS_SYNC_STATUS', anchor='e').grid(row=33, column=0, stick=W)
label_EDGE_GPS_SYNC_VAL = Label(_frame, text='EDGE_GPS_SYNC_VAL', anchor='e').grid(row=34, column=0, stick=W)
label_EDGE_MW_COMM_STATUS = Label(_frame, text='EDGE_MW_COMM_STATUS', anchor='e').grid(row=35, column=0, stick=W)
label_BAD_VAL_COUNT = Label(_frame, text='BAD_VAL_COUNT', anchor='e').grid(row=36, column=0, stick=W)
label_BAD_CRC_COUNT = Label(_frame, text='BAD_CRC_COUNT', anchor='e').grid(row=37, column=0, stick=W)
label_NO_RSPNS_COUNT = Label(_frame, text='NO_RSPNS_COUNT', anchor='e').grid(row=38, column=0, stick=W)
label_COMM_FAILURE_COUNT = Label(_frame, text='COMM_FAILURE_COUNT', anchor='e').grid(row=39, column=0, stick=W)
label_COMM_SUCCESS_COUNT = Label(_frame, text='COMM_SUCCESS_COUNT', anchor='e').grid(row=40, column=0, stick=W)
label_AVERAGE_TRANS_TIME = Label(_frame, text='AVERAGE_TRANS_TIME', anchor='e').grid(row=41, column=0, stick=W)
label_QUEUED_NPW_BUFFERS = Label(_frame, text='QUEUED_NPW_BUFFERS', anchor='e').grid(row=42, column=0, stick=W)
label_AVG_RESPONSE_TIME = Label(_frame, text='AVG_RESPONSE_TIME', anchor='e').grid(row=43, column=0, stick=W)
label_PACKET_DROP_COUNT = Label(_frame, text='PACKET_DROP_COUNT', anchor='e').grid(row=44, column=0, stick=W)
...
label_MW17 = Label(_frame, text='MW17', width=_width).grid(row=0, column=10, stick=W)
label_MW18 = Label(_frame, text='MW18', width=_width).grid(row=0, column=11, stick=W)
label_MW19 = Label(_frame, text='MW19', width=_width).grid(row=0, column=12, stick=W)
