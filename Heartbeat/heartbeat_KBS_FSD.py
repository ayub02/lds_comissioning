...
def on_message(_client, _userdata, _message):
    ...
    if 't_hb_BV69' in msg:
        ...
        hb_bv69.create_labels(1)
    if 't_hb_BV70' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_bv70.update_prop(msg['t_hb_BV70'], msg['registerMap_BV70'])
        hb_bv70.create_labels(2)
    if 't_hb_BV70A' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_bv70A.update_prop(msg['t_hb_BV70A'], msg['registerMap_BV70A'])
        hb_bv70A.create_labels(3)
    if 't_hb_BV71' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_bv71.update_prop(msg['t_hb_BV71'], msg['registerMap_BV71'])
        hb_bv71.create_labels(4)
    if 't_hb_BV72' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_bv72.update_prop(msg['t_hb_BV72'], msg['registerMap_BV72'])
        hb_bv72.create_labels(5)
    if 't_hb_BV72A' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_bv72A.update_prop(msg['t_hb_BV72A'], msg['registerMap_BV72A'])
        hb_bv72A.create_labels(6)
    if 't_hb_FSD1' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_fsd1.update_prop(msg['t_hb_FSD1'], msg['registerMap_FSD1'])
        hb_fsd1.create_labels(7)
    if 't_hb_MW20' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw20.update_prop(msg['t_hb_MW20'], msg['registerMap_MW20'])
        hb_mw20.create_labels(8)
    if 't_hb_MW21' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw21.update_prop(msg['t_hb_MW21'], msg['registerMap_MW21'])
        hb_mw21.create_labels(9)
    if 't_hb_MW22' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw22.update_prop(msg['t_hb_MW22'], msg['registerMap_MW22'])
        hb_mw22.create_labels(10)
    if 't_hb_MW23' in msg:
        print(datetime.now(), '\t\t\t', msg)
        hb_mw23.update_prop(msg['t_hb_MW23'], msg['registerMap_MW23'])
        hb_mw23.create_labels(11)
...
mqtt_topics = [('FSD1', 1), ('MW20', 1), ('MW21', 1), ('MW22', 1), ('MW23', 1)]
...
_width = 16
label_BV69 = Label(_frame, text='BV69', width=_width).grid(row=0, column=1, stick=W)
label_BV70 = Label(_frame, text='BV70', width=_width).grid(row=0, column=2, stick=W)
label_BV70A = Label(_frame, text='BV70A', width=_width).grid(row=0, column=3, stick=W)
label_BV71 = Label(_frame, text='BV71', width=_width).grid(row=0, column=4, stick=W)
label_BV72 = Label(_frame, text='BV72', width=_width).grid(row=0, column=5, stick=W)
label_BV72A = Label(_frame, text='BV72A', width=_width).grid(row=0, column=6, stick=W)
label_FSD1 = Label(_frame, text='FSD1', width=_width).grid(row=0, column=7, stick=W)
label_MW20 = Label(_frame, text='MW20', width=_width).grid(row=0, column=8, stick=W)
label_MW21 = Label(_frame, text='MW21', width=_width).grid(row=0, column=9, stick=W)
label_MW22 = Label(_frame, text='MW22', width=_width).grid(row=0, column=10, stick=W)
label_MW23 = Label(_frame, text='MW23', width=_width).grid(row=0, column=11, stick=W)
