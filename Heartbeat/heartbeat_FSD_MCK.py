...
mqtt_topics = [('FSD2', 1), ('MW24', 1), ('MW25', 1), ('MCK1', 1)]
...
_width = 16
label_FSD2 = Label(_frame, text='FSD2', width=_width).grid(row=0, column=1, stick=W)
label_BV74A = Label(_frame, text='BV74A', width=_width).grid(row=0, column=2, stick=W)
label_BV75 = Label(_frame, text='BV75', width=_width).grid(row=0, column=3, stick=W)
label_BV76 = Label(_frame, text='BV76', width=_width).grid(row=0, column=4, stick=W)
label_MCK1 = Label(_frame, text='MCK1', width=_width).grid(row=0, column=5, stick=W)
